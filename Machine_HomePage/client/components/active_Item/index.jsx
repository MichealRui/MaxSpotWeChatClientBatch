...
export default class Item extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={"item active_item sliderItem"} onClick={() => this.showClick.bind(this)(props)}>
                {
                    props.imagePath ?
                ...
                <span className='brandProductContainer'>
                    <p className={'productName font20'}>{props.brandName}</p>
                    <p className='productDesc font25'>{props.shortName}</p>
                    <p className={'categoryName font18'}>
                    {atts}
                    </p>
                </span>

                <span className='unitPrice font30'>{props.sellprice / 100 || 0}<span className="font18">元</span></span>
                {
                    props.quantity > 0 ?
                        <span>
                            <span className={"oldPrices font16 "}>市场价 {props.msrp/100}元</span>
